...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'lineup-optimizer', canActivate: [SubscriptionGuard], canActivateChild: [SubscriptionGuard], component: LineupOptimizerComponent, children: [
        { path: 'mlb', component: LineupOptimizerComponent },
        { path: 'nfl', component: NFLLineupOptimizerComponent },
        { path: 'nba', component: NBALineupOptimizerComponent }
      ] },
      {path: 'lineup-optimizer/mlb', component: LineupOptimizerComponent},
      {path: 'lineup-optimizer/nfl', component: NFLLineupOptimizerComponent},
      {path: 'lineup-optimizer/nba', component: NBALineupOptimizerComponent},
